	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				INSERT dbo.BitacoraEvento( 	---Inserci�n de evento Login Deshabilitado a BitacoraEventos
					IdTipoEvento
					,IdPostByUser
					,Descripcion
					,PostInIp
		...
		INSERT dbo.BitacoraEvento( 		---Inserci�n de evento Login Exitoso a BitacoraEventos
			IdTipoEvento
			,IdPostByUser
			,Descripcion
			,PostInIp

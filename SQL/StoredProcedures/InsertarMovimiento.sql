...
BEGIN
	...
	BEGIN TRY
		...
		DECLARE @saldoActualEmpleado INT; ---Saldo que ya ten�a el empleado antes de movimiento
		...
		IF @saldoFinalEmpleado < 0 ---Revisar si saldo de empleado dar� negativo
		BEGIN
		...
		BEGIN
			...
			BEGIN TRANSACTION tInsertarMovimiento
				...
				---Actualizar informaci�n de saldo del empleado
				UPDATE dbo.Empleado
				SET 
